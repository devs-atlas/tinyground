...
//TODO: IMPLEMENT
//we only have access to EXP2, aka 2^x
//compute same thing by doing 1/(1+2^(-x/log(2)))
export class Sigmoid extends Fn {
  ret;
  forward([x]) {
    this.ret = x.const(1).e("DIV", x.const(1).e("ADD", x.e("MUL", x.const(-1 / Math.log(2)).e("EXP2"))));
    return this.ret;
  }
  // TODO: backward
}
